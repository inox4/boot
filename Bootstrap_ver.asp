...
<html lang="en-US">
<head>
<title>Choose a Bootstrap Version (3, 4 or 5)</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C++, jQuery, Bootstrap, Bootstrap 4, Bootstrap 5, C#, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Courses, Lessons, References, Examples, Source code, Demos, Tips">
...
<div class="w3-bar xw3-card-2 notranslate" style="padding-left:12px;padding-right:16px;">
  ...
  <!--
  <a class="w3-bar-item w3-button bar-item-hover barex ws-green" style="margin-top:16px;width:132px;border-radius:25px;margin-left:8px;margin-right:8px;">PRO</a>
  -->
  ...
  <div class="w3-right w3-padding-16">
    <a class="w3-bar-item w3-button w3-right ws-hide-950 w3-hide-small barex ws-yellow ws-hover-yellow gt-btn-top-spaces" style="border-radius: 25px; margin-right: 15px;" href="https://www.w3schools.com/spaces" target="_blank" title="Get Your Own Website With W3Schools Spaces"><span class="ws-hide-900">Create </span>Website</a>
    <a class="w3-bar-item w3-button w3-right ws-hide-1080 w3-hide-small barex ws-pink ws-hover-pink gt-btn-top-cert" style="border-radius: 25px; margin-right: 15px;" href="https://shop.w3schools.com/collections/course-catalog" target="_blank" id="cert_navbtn" title="Courses">Get Certified</a>
    <a class="ws-black w3-bar-item w3-button w3-right w3-hover-dark-grey w3-hide-small ws-hide-1250 barex topnavmain_pro gt-btn-top-pro" style="border-radius: 25px; margin-right: 15px;" href="/pro/index.php" title="Go pro and unlock powerful features">Upgrade</a>    
  </div>
...
<div id='myAccordion' class="w3-card-2 w3-center w3-hide-large" style="display:none;cursor:default;background-color:#E7E9EB;color:black!important">
  ...
  <div class="w3-container w3-padding-32">
    ...
    <a class="w3-button w3-block" style="font-size:22px;" href="https://www.w3schools.com/spaces" target="_blank" title="Get Your Own Website With W3shools Spaces">Spaces</a>
...
<nav id="nav_tutorials" class="w3-hide-small navex" style="position:absolute;background-color:#282A35;color:white;padding-bottom:60px;">
 ...
 <div class="w3-col l3 m6">
   ...
   <a class="w3-bar-item w3-button" href="https://www.w3schools.com/spaces" target="_blank" title="Get Your Own Website With W3shools Spaces">Create a Website <span class="ribbon-topnav ws-yellow">NEW</span></a>
...
<div class="ws-black w3-center" style="padding-top:90px;padding-bottom:70px;">
  <div class="w3-content" style="padding-left:20px;padding-right:20px;max-width:1200px">
    <h1 style="font-size:67px;font-weight:700;" class="textsmallerscreens">Bootstrap Versions</h1>
    <h3 style="margin-top:50px;margin-bottom:20px;">Bootstrap is the world's most famous free CSS framework.<br>You can choose between the following versions:</h3>
    <br><br>
    
    <div class="colx-container">
    

    <a href="/bootstrap/default.asp" class="w3-hover-text-light-grey">
      <div class="colx firstx" style="background-color:#846bae;color:white">
        <h4 class="b-headings">B3</h4>
        <p><a href="/bootstrap/default.asp" class="w3-button w3-round w3-margin-top w3-margin-bottom w3-border w3-hover-white" style="font-size:19px">Learn Bootstrap 3 &raquo;</a></p>
        <p style="font-size:17px;">Bootstrap 3 is the most stable version of Bootstrap, and it is still supported by the team for critical bugfixes and documentation changes.</p>
      </div>
    </a>
    
    <a href="/bootstrap4/default.asp" class="w3-hover-text-light-grey">
      <div class="colx" style="background-color:#5f4884;color:white">
        <h4 class="b-headings">B4</h4>
        <p><a href="/bootstrap4/default.asp" class="w3-button w3-round w3-margin-top w3-margin-bottom w3-border w3-hover-white" style="font-size:19px">Learn Bootstrap 4 &raquo;</a></p>
        <p style="font-size:17px;">Bootstrap 4 is a newer version of Bootstrap; with new components, faster stylesheet and more responsiveness. However, Internet Explorer 9 and down is not supported.</p>
      </div>
    </a>

    <a href="/bootstrap5/index.php" class="w3-hover-text-light-grey">
      <div class="colx lastx" style="background-color:#6c3ec1;color:white">
        <h4 class="b-headings">B5</h4>
        <p><a href="/bootstrap5/index.php" class="w3-button w3-round w3-margin-top w3-margin-bottom w3-border w3-hover-white" style="font-size:19px">Learn Bootstrap 5 &raquo;</a></p>
        <p style="font-size:17px;">Bootstrap 5 is the <strong>newest </strong>version of Bootstrap; with a smooth overhaul. However, Internet Explorer 11 and down is not supported, and jQuery is replaced with vanilla JavaScript.</p>
      </div>
    </a>
